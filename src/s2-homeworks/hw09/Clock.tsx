...
function Clock() {
    ...
    const [buttonActivation, setbuttonActivation] = useState<boolean>(false)
    ...
    const stringDay = date.toLocaleString("en-uk", {weekday: "short"}) || <br/> // пишут студенты
    const stringMonth = date.toLocaleString("en-uk", {month: "short"}) || <br/> // пишут студенты
